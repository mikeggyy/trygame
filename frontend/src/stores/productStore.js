...
export const product = defineStore({
  ...
  state: () => ({
    productList: [
      ...
      { name: '玻璃瓷器', value: 0, orderId: 52, minMoney: 5.01, maxMoney: 11.69, averageMoney: 8.35 },
      { name: '鴉片', value: 0, orderId: 53, minMoney: 3.34, maxMoney: 8.35, averageMoney: 5.01 },
      { name: '洋酒', value: 0, orderId: 54, minMoney: 8.35, maxMoney: 16.67, averageMoney: 12.52 }
    ]
  }),
  actions: {
    getProductItem(name) {
